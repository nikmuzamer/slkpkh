...
<div id="wrapper">
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
			  <h2 class="title"><a href="#">Manual Pengguna </a></h2>
				...
				<div class="entry">
				  <p>Manual Pengguna ini adalah untuk rujukan dan panduan pengguna.</p>
				  <p>Sila klik pautan di bawah</p>
				  <p><a href="Docs/manual.pdf" target="_blank"> <img src="images/help.png" alt="" width="16" height="16" /> Manual Pengguna</a></p>
              </div>
		  </div>
		</div>
		<!-- end #content -->
