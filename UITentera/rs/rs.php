...
<div id="content">
  ...
  <div class="post">
				<a name="Menu_syarat" id="Menu_syarat"></a></h2>
				<p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Wednesday, 11 March, 2015 3:12 PM<!-- #EndDate -->
				m</p>
				<div class="entry">
                <div class="arial14bold" align="center">Masukkan No Matrik pegawai kadet. <br />
                  </div>
                <br />
				  ...
				  <table border="0" cellspacing="0" cellpadding="0" width="643">
				    <tr>
				      <td height="76"><fieldset>
			            <legend>Lapor Kesalahan</legend>
                        <br />
                        <br />
                       <form>
                        <p>
      <input type="text" placeholder="No Matrik" required>
