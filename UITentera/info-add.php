	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
			  ...
			  <p class="meta">Kemaskini terakhir pada &lt;!-- #BeginDate format:En2a --&gt;21-May-2010 11:49 AM&lt;!-- #EndDate --&gt;<a href="mailto:staf.ict@upnm.edu.my"></a></p>
				<div class="entry">
				  <p>Maklumat telah berjaya disimpan. </p>
				</div>
			</div>
	  </div>
		<!-- end #content -->
