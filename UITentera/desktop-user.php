...
//  echo "Authorized=".isAuthorized("",$MM_authorizedUsers, $_SESSION['MM_Username'], $_SESSION['MM_UserGroup']);
...
<body>
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Akaun Pengguna</a><a name="Menu_syarat" id="Menu_syarat"></a></h2>
				<p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Wednesday, 25 March, 2015 2:52 PM<!-- #EndDate -->
				m</p>
				<div class="entry">
                <div class="arial14bold" align="center">Terima Kasih kerana menggunakan Sistem Laporan Kesalahan Pegawai Kadet dan Hukuman. <br />
                  </div>
                <br />
                
				  <table border="0" cellspacing="0" cellpadding="0" width="643">
        <legend>Laman Utama  ADMINISTRATOR</legend>
				    ...
				    <tr>
                      ...
                      <table width="100%" height="44" border="1" align="center">
				            ...
				            <td height="30" width="60%" ><div class="arial14bold" align="center" bgcolor="#e8eaeb">Nama</div></td>
				            <td height="30" width="40%" align="right"><div class="arial14bold" align="center" bgcolor="#e8eaeb">No Staf</div></td>
			              </tr>
