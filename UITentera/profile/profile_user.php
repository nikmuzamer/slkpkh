...
<div id="wrapper">
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    <h2 class="title"><a href="#">Kemaskini Profil</a></h2>
				<p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Wednesday, 11 March, 2015 7:38 AM<!-- #EndDate -->
			</p>
				<div class="entry">
		...
		<td width="498"><?php echo $row_rsUser['f142Name']; ?></td>
				      ...
				      <tr>
		<td align="right"><div align="right"><strong>No Staf/ No Tentera : </strong></div></td>
