...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsMohonJawatan = sprintf("SELECT * FROM t144mohon_jawatan WHERE ICNO = %s AND jaw_kategori=2 ORDER BY mohonID ASC", GetSQLValueString($colname_rsMohonJawatan, "text"));
...
.ARIALsize14bold {	font-family: Arial, Helvetica, sans-serif;
	font-size: 14px;
	font-weight: bold;
	color: #000;
}
...
<body>
	...
	<div id="page-bgtop">
	  <table width="800" height="100%" border="0" align="center" cellspacing="0">
	    <tr>
	      <td width="157" rowspan="2" bgcolor="#FFFFFF"><img src="../../images/logotip.jpg" alt="" width="136" height="130" /></td>
	      <td width="616" rowspan="2" bgcolor="#FFFFFF" class="BIGTITLE">UNIVERSITI PERTAHANAN NASIONAL MALAYSIA<br /><br />
          <span class="ARIALsize14bold">BORANG JAWATAN BUKAN AKADEMIK</span></td>
	      <td width="120" align="center" bgcolor="#FFFFFF" class="arialsize12">UPNM/PEND-01</td>
        </tr>
	    <tr>
	      <td height="60" bgcolor="#FFFFFF" class="tengah"><?php
	        ...
	        <div class="entry">
	          <form id="frmPeribadi" method="post">
	            <table width="100%" border="0">
	              <tr>
	                <td><table width="815" border="0" cellspacing="0" height="34">
	                  <tr>
	                    
	                    <td width="100%" height="80" align="center" valign="top" bgcolor="#CCCCCC"><?php do { ?>
                          <span class="arialsize14bol"><br /><?php echo "JAWATAN " .$row_rsMohonJawatan['recordID']. ":"; ?> <?php echo $row_rsMohonJawatan['jawatanDesc']; ?> - <?php echo $row_rsMohonJawatan['jawatanGred']; ?>
	              ...
	              <tr>
	                <td height="180">
	                  ...
	                  <table width="100%" border="0">
	                    <tr class="arialsize12">
	                      <td width="20%" height="25" align="right"><span class="cetak">NAMA :</span></td>
						  <td width="80%" height="25" colspan="3" align="left" class="cetak"> <?php echo $row_rsPeribadi['f786desc']; ?> <?php echo $row_rsUser['f142Name']; ?> <?php echo $row_rsPeribadi['JANTINA']; ?></td>
	                      </tr>
	                    <tr>
	              ...
	              <tr>
	                <td width="251" height="17"><fieldset>
	                  ...
	                  <table width="100%" border="1" cellspacing="0">
	                    <tr class="arialsize14bol" height="30">
	                      <td width="40%" bgcolor="#E9E9E9">SEKOLAH/INSTITUSI/UNIVERSITI</td>
	                      <td width="15%" bgcolor="#E9E9E9">TAHAP KELULUSAN</td>
	                      <td width="15%" bgcolor="#E9E9E9">NAMA KELULUSAN</td>
	                      <td width="15%" bgcolor="#E9E9E9">GRED</td>
	                      <td width="15%" bgcolor="#E9E9E9">TARIKH DIKURNIAKAN</td>
	                      </tr>
	                    <?php do { ?>
	                      <tr class="arialsize12" height="30">
	                        <td class="arialsize12" height="12"><?php echo $row_rsAkademik['f777desc']; ?></td>
	              ...
	              <tr>
	                <td height="20"><fieldset>
	                  <legend>KEPUTUSAN AKADEMIK BAGI MATAPELAJARAN WAJIB<strong>
	              ...
	              &lt;tr&gt;
	                &lt;td height="20" colspan="4" />
	                  ...
	                  <table width="100%" height="34" border="1" cellspacing="0">
	                    <tr class="arialsize14bol" height="30">
	                      <td width="40%" height="16" bgcolor="#E9E9E9"><span class="cetak">KELULUSAN</span></td>
	                      <td width="20%" bgcolor="#E9E9E9" class="arialsize14bol">BM - Gred</td>
	                      <td width="20%" bgcolor="#E9E9E9" class="arialsize14bol">BI -Gred</td>
	                      <td width="20%" bgcolor="#E9E9E9" class="arialsize14bol">MATH -Gred</td>
	                      </tr>
	                    <?php do { ?>
	                    <tr class="arialsize12" height="30">
	              ...
	              <tr>
	                <td height="20"><fieldset>
                      <legend>PENGALAMAN KERJA<strong>
	              ...
	              &lt;tr&gt;
	                &lt;td height="20" colspan="4" />
                      ...
                      <table width="100%" border="1" cellspacing="0">
                        <tr class="arialsize14bol" height="30">
                          <td width="40%" bgcolor="#E9E9E9"><span class="cetak">NAMA ORGANISASI</span></td>
                          <td width="30%" bgcolor="#E9E9E9">TARIKH BERKHIDMAT</td>
                          <td width="30%" bgcolor="#E9E9E9">TARIKH TAMAT BERKHIDMAT</td>
                        </tr>
                        <?php do { ?>
                        <tr class="arialsize12" height="30">
	              ...
	              &lt;tr&gt;
	                &lt;td height="20" colspan="4" />
	                  ...
	                  <table width="100%" height="40" border="1" cellspacing="0">
	                    <tr class="arialsize14bol" height="30">
	                      <td width="40%" bgcolor="#E9E9E9"><span class="cetak">BAHASA</span></td>
	                      <td width="30%" bgcolor="#E9E9E9"><span class="cetak">TAHAP TULISAN</span></td>
	                      <td width="30%" bgcolor="#E9E9E9"><span class="cetak">TAHAP PERTUTURAN</span></td>
	                      </tr>
	                    <?php do { ?>
	                    <tr class="arialsize12" height="30">
	              ...
	              <tr>
	                <td height="17"><fieldset>
                      <legend>KEMAHIRAN KOMPUTER<strong>
	              ...
	              &lt;tr&gt;
	                &lt;td height="20" colspan="4" />
	                  ...
	                  <table width="100%" height="35" border="1" cellspacing="0">
	                    <tr class="arialsize14bol" height="30">
	                      <td width="70%" height="17" bgcolor="#E9E9E9"><span class="cetak">JENIS KEMAHIRAN</span></td>
	                      <td width="30%" bgcolor="#E9E9E9"><span class="cetak">TAHAP KEMAHIRAN</span></td>
	                      </tr>
	                    <?php do { ?>
	              ...
	              <tr>
	                <td height="20"><fieldset>
                      <legend>KEMAHIRAN LESEN MEMANDU<em> (Jawatan Pemandu dan Pembantu Am)</em><em><strong>
                      <input name="hdnLesenICNO" type="hidden" id="hdnLesenICNO" value="<?php echo $row_rsLesen['']; ?>
                  &lt;/tr&gt;
	              &lt;tr&gt;
	                &lt;td height="20" colspan="4" />
	                  </strong></em>	                  </legend>
	                  <table width="100%" height="34" border="1" cellspacing="0">
	                    <tr class="arialsize14bol" height="30">
	                      <td width="70%" height="16" bgcolor="#E9E9E9" >JENIS LESEN</td>
	                      <td width="30%" bgcolor="#E9E9E9">KELAS LESEN</td>
	                      </tr>
	                    <?php do { ?>
	                    <tr class="arialsize12" height="30">
	                      <td height="16" bgcolor="#FFFFFF"><?php echo $row_rsLesen['LicType']; ?></td>
	                      <td bgcolor="#FFFFFF"><span class="cetak"><?php echo $row_rsLesen['LicClass']; ?></span></td>
	                      </tr>
	              ...
	              <tr>
	                <td height="20"><fieldset>
	                  <legend>RUJUKAN <em>(Nama dan alamat DUA orang yang bukan saudara untuk rujukan)</em><em><strong>
	              ...
	              &lt;tr&gt;
	                &lt;td height="20" colspan="4" />
	                  ...
	                  <table width="100%" height="34" border="1" cellspacing="0">
	                    <tr class="arialsize14bol" height="30">
	                      <td height="16" bgcolor="#E9E9E9" width="70%"><span class="cetak">NAMA RUJUKAN</span></td>
	                      <td bgcolor="#E9E9E9" width="30%"><span class="cetak">ALAMAT</span></td>
	                      </tr>
	                    <?php do { ?>
	                    <tr class="arialsize12" height="30">
	                      <td height="16" bgcolor="#FFFFFF"><span class="cetak"><?php echo $row_rsRujukan['f100namarujuk']; ?></span></td>
	                      <td bgcolor="#FFFFFF"><span class="cetak"><?php echo $row_rsRujukan['f100almtrujuk']; ?></span></td>
	                      </tr>
	              ...
	              <tr>
	                <td height="17"><a href="#" onclick="return cetak()">Cetak Sekarang</a></td>
                  </tr>
                </table>
              </form>
            </div>
