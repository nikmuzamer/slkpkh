...
$icnoakaun_rsSemakPemohon = "-1";
if (isset($_POST['txtnoic'])) {
  $icnoakaun_rsSemakPemohon = $_POST['txtnoic'];
}
$icnojawatan_rsSemakPemohon = "-1";
if (isset($_POST['txtnoic'])) {
  $icnojawatan_rsSemakPemohon = $_POST['txtnoic'];
}
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsSemakPemohon = sprintf("SELECT DISTINCT t142_akaun.f142Name, t142_akaun.f142noIC, t144mohon_jawatan.cv FROM t142_akaun, t144mohon_jawatan WHERE t142_akaun.f142noIC=%s and t144mohon_jawatan.ICNO=%s ORDER BY t142_akaun.f142Name ASC", GetSQLValueString($icnoakaun_rsSemakPemohon, "text"),GetSQLValueString($icnojawatan_rsSemakPemohon, "text"));
$rsSemakPemohon = mysql_query($query_rsSemakPemohon, $sqlconn) or die(mysql_error());
$row_rsSemakPemohon = mysql_fetch_assoc($rsSemakPemohon);
$totalRows_rsSemakPemohon = mysql_num_rows($rsSemakPemohon);
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form id="form1" method="post" action="int_semakanPemohonIC.php">
<table width="643" height="198">
  <tr>
    <td><strong>INFO:</strong></td>
          </tr>
  <tr>
    <td><em>*Sila masukkan No Kad Pengenalan untuk Carian dan tekan butang Cari</em></td>
          </tr>
  <tr>
    <td>&nbsp;</td>
          </tr>
  <tr>
    <td height="51" align="center" valign="top"><table width="650" height="47">
      <tr>
        <td><fieldset>
          <legend>Borang Carian Menggunakan <i>Keyword</i> No Kad Pengenalan</legend>
          <table width="100%" border="0">
            <tr>
              <td width="25%" valign="top"><div align="right" class="unbold"><strong><img src="../../images/featured.png" alt="" width="16" height="16" />No Kad Pengenalan :</strong></div></td>
              <td width="75%" valign="top"><label><span id="sprytxtNamaPemohon">
                <input name="txtnoic" type="text" id="txtnoic" size="50" />
  ...
  <tr>
    <td align="center"><table width="100%" border="1">
      ...
      <?php } while ($row_rsSemakPemohon = mysql_fetch_assoc($rsSemakPemohon)); ?>
                ...
                <p>&nbsp;                Rekod <?php echo ($startRow_rsPeribadi + 1) ?> hingga <?php echo min($startRow_rsPeribadi + $maxRows_rsPeribadi, $totalRows_rsPeribadi) ?> daripada <?php echo $totalRows_rsPeribadi ?> rekod.</p>
</form>
	        </div>
	      </div>
</div>
