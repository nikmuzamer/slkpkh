...
<td><table width="640" height="53">
  <tr>
    <td><fieldset>
      <legend>Laman Modul Temuduga Sistem E-Recruitment</legend>
      1. <a href="#Syarat_pertama">Objektif</a><br />
      2. <a href="#Syarat_kedua">Deskripsi</a><br />
      </fieldset></td>
            </tr>
  </table>
  <p><strong>1)&nbsp; Objektif Modul Temuduga<a name="Syarat_pertama" id="Syarat_pertama"></a></strong></p>
  <ul type="disc">
    <li>Calon-calon yang terpilih akan mendapat dipanggil temuduga </li>
    <li>Surat panggilan temuduga akan dihantar ke alamat calon dan diruskan oleh Jabatan Pendaftar.<a href="#Menu_syarat"><img src="../../images/arrow-up-icon.png" alt="" width="24" height="24" /></a></li>
          </ul>
  <p><strong>2)&nbsp;&nbsp;Deskripsi Modul Temuduga<a name="Syarat_kedua" id="Syarat_kedua"></a>&nbsp; </strong></p>
  <ul type="disc">
