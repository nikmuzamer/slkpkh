...
$query_rscacat = "SELECT * FROM t109kod_cacat";
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    S</p>
		    <div class="entry">
		      <form id="form1" method="post" action="cacat.php">
<table width="643" height="123">
  ...
  <tr>
    <td><a href="cacat-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Cacat</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Cacat</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Cacat</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rscacat['f109cacatDesc']; ?></td>
                          <td class="center">
                          
                          <a href="cacat-add.php"></a>
                          
                          <a href="cacat-edit.php?ID=<?php echo $row_rscacat['f109cacatID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="cacat-delete.php?ID=<?php echo $row_rscacat['f109cacatID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rscacat = mysql_fetch_assoc($rscacat)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
