...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="sebab cacat-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Sebab Cacat</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Sebab Cacat</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Sebab Cacat</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsSebabcacat['DisabilityCause']; ?></td>
                          <td class="center">
                          
                       <a href="sebab cacat-add.php"></a>
                          
                          <a href="sebabcacat-edit.php?ID=<?php echo $row_rsSebabcacat['f109SebabCacatID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="sebabcacat-delete.php?ID=<?php echo $row_rsSebabcacat['f109SebabCacatID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsSebabcacat = mysql_fetch_assoc($rsSebabcacat)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
