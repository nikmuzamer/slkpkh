...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmAgama")) {
  $insertSQL = sprintf("INSERT INTO t109kod_agama (f761kod, f761desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtagama"></label>
          ...
          <input type="text" name="txtagama" id="txtagama" />
      ...
      <tr>
        ...
        <td><label for="txtkdagama"></label>
          <span id="txtsprykdagama">
                          ...
                          <input type="text" name="txtkdagama" id="txtkdagama" />
...
<input type="hidden" name="MM_insert" value="frmAgama" />
              </form>
	        </div>
	      </div>
</div>
