...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmSebabcacat")) {
  $insertSQL = sprintf("INSERT INTO t109kod_sebabcacat (f109sebabCacatKod, f109SebabCacatDesc) VALUES (%s, %s)",
...
<table width="643" height="70">
  ...
  <tr>
    <td><em>*Tambah Sebab Cacat</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtsebabcacat"></label>
	                    ...
	                    <input type="text" name="txtsebabcacat" id="txtsebabcacat" />
      ...
      <tr>
        ...
        <td><label for="txtkdsebabcacat"><span id="txtsprykdsebabcacat">
                        <input type="text" name="txtkdsebabcacat" id="txtkdsebabcacat" />
...
<input type="hidden" name="MM_insert" value="frmSebabcacat" />
              </form>
	        </div>
	      </div>
</div>
