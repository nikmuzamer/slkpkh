...
<table width="643" height="123">
  ...
  <tr>
    <td><em>*Kemaskini subjek</em></td>
	              </tr>
  <tr>
    <td><a href="subjek-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Subjek</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Subjek</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Subjek</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsSubjek['f109keterangan']; ?></td>
                          <td class="center">
                          
                          <a href="subjek-add.php"></a>
                          
                          <a href="subjek-edit.php?ID=<?php echo $row_rsSubjek['f109IDsubjek']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="subjek-delete.php?ID=<?php echo $row_rsSubjek['f109IDsubjek']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsSubjek = mysql_fetch_assoc($rsSubjek)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
