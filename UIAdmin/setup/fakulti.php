...
$query_rsfakulti = "SELECT * FROM t109kod_faculty";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="fakulti-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Fakulti</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Fakulti</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Fakulti</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsfakulti['f109facultyDesc']; ?></td>
                          <td class="center">
                          
                          <a href="fakulti-add.php"></a>
                          
                          <a href="fakulti-edit.php?ID=<?php echo $row_rsfakulti['f109facultyID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="fakulti-delete.php?ID=<?php echo $row_rsfakulti['f109facultyID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsfakulti = mysql_fetch_assoc($rsfakulti)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
