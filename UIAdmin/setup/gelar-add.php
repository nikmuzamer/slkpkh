...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmGelaran")) {
  $insertSQL = sprintf("INSERT INTO t109kod_gelar (f786kdgelar, f786desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="636" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtGelaran"></label>
	                    <label for="txtBahasa"><span id="txtspryGelaran">
	                      <input type="text" name="txtGelaran" id="txtGelaran" />
      ...
      <tr>
        ...
        <td><label for="txtkdGelaran"><span id="txtsprykdGelaran">
                        <input type="text" name="txtkdGelaran" id="txtkdGelaran" />
                        <span class="textfieldRequiredMsg">*Wajib diisi.</span></span></label></td>
	                  </tr>
      <tr>
        <td>&nbsp;</td>
...
<input type="hidden" name="MM_insert" value="frmGelaran" />
		      </form>
	        </div>
	      </div>
</div>
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("txtsprykdGelaran", "none");
</script>
</body>
</html>
<?php
