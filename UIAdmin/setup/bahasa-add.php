...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmBahasa")) {
  $insertSQL = sprintf("INSERT INTO t109kod_bahasa (f109kdbahasa, f109desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="634" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtbahasa"></label>
	                    <label for="txtBahasa"><span id="txtsprybahasa">
	                      <input type="text" name="txtbahasa" id="txtbahasa" />
      ...
      <tr>
        ...
        <td><label for="txtkdbahasa"><span id="txtsprykdbahasa">
                        <input type="text" name="txtkdbahasa" id="txtkdbahasa" />
...
<input type="hidden" name="MM_insert" value="frmBahasa" />
              </form>
	        </div>
	      </div>
</div>
