	...
	<div id="page-bgtop">
	  <div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form method="POST" enctype="multipart/form-data" name="frmBandar" id="frmBandar">
