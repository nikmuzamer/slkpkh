...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="bangsa-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Bangsa</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Bangsa</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Bangsa</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsbangsa['f109desc']; ?></td>
                          <td class="center">
                          
                          <a href="bangsa-add.php"></a>
                          
                          <a href="bangsa-edit.php?ID=<?php echo $row_rsbangsa['f109IDbangsa']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="bangsa-delete.php?ID=<?php echo $row_rsbangsa['f109IDbangsa']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsbangsa = mysql_fetch_assoc($rsbangsa)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
