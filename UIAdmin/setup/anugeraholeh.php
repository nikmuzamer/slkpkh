...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsAnugerahOleh = "SELECT * FROM t109kod_anugeraholeh";
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form id="frm_anugeraholeh" method="post" action="agama.php">
<table width="643" height="123">
  ...
  <tr>
    <td><a href="anugeraholeh-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Anugerah oleh</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Anugerah Oleh</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Anugerah Oleh</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsAnugerahOleh['CfdBy']; ?></td>
                          <td class="center"><a href="agama-add.php"></a> 
                          
                          <a href="anugeraholeh-edit .php?ID=<?php echo $row_rsAnugerahOleh['CfdByID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a> 
                          
                          <a href="anugeraholeh-delete.php?ID=<?php echo $row_rsAnugerahOleh['CfdByID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsAnugerahOleh = mysql_fetch_assoc($rsAnugerahOleh)); ?>
                    </table></td>
	              </tr>
	            </table>
<p>&nbsp;</p>
