  ...
  <hr />
    ...
    <div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form name="frmFWarga" id="frmWarga" method="POST">
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("txtsprykdwarga", "integer");
//-->
</script>
</body>
</html>
