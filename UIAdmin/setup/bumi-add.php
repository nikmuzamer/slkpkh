...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmBumi")) {
  $insertSQL = sprintf("INSERT INTO t109kod_bumi (f109kdBumi, f109bumiDesc) VALUES (%s, %s)",
...
<table width="643" height="70">
  ...
  <tr>
    <td><em>*Tambah Status Bumiputra</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
    ...
    <td align="center"><table width="634" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtbumi"></label>
	                    <label for="txtBahasa"><span id="txtsprybumi">
	                      <input type="text" name="txtbumi" id="txtbumi" />
      ...
      <tr>
        ...
        <td><label for=""><span id="txtsprykdbumi">
                        <input type="text" name="txtkdbumi" id="txtkdbumi" />
...
<input type="hidden" name="MM_insert" value="frmBumi" />
		      </form>
          </div>
	      </div>
</div>
