...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmAnugerahOleh")) {
  $insertSQL = sprintf("INSERT INTO t109kod_anugeraholeh (CfdByCd, CfdBy) VALUES (%s, %s)",
                       GetSQLValueString($_POST['txtkdAnugerahOleh'], "text"),
                       GetSQLValueString($_POST['textAnugerahOleh'], "text"));

  mysql_select_db($database_sqlconn, $sqlconn);
  $Result1 = mysql_query($insertSQL, $sqlconn) or die(mysql_error());

  $insertGoTo = "anugeraholeh.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="643" height="70">
  ...
  <tr>
    <td><em>*Tambah Anugerah Oleh</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
  <tr>
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="textAnugerahOleh"></label>
	                    <label for="txtagama"><span id="sprytextAnugerahOleh">
	                      <input name="textAnugerahOleh" type="text" id="textAnugerahOleh" size="30" />
                        <span class="textfieldRequiredMsg">*Wajib diisi.</span></span></label></td>
	                  </tr>
      <tr>
        <td><div align="right"><strong>Kod Anugerah Oleh:</strong></div></td>
        <td><label for="txtkdAnugerahOleh"></label>
	                    <label for="textkdAnugerah"><span id="sprytxtkdAnugerahOleh">
                        <input type="text" name="txtkdAnugerahOleh" id="txtkdAnugerahOleh" />
...
<input type="hidden" name="MM_insert" value="frmAnugerahOleh" />
              </form>
            </div>
	      </div>
</div>
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextAnugerahOleh");
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytxtkdAnugerahOleh", "integer");
</script>
</body>
</html>
<?php
