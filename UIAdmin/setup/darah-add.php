...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmDarah")) {
  $insertSQL = sprintf("INSERT INTO t109kod_darah (f761kod, f761desc) VALUES (%s, %s)",
...
<table width="643" height="70">
  ...
  <tr>
    <td><em>*Tambah jenis darah</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
    ...
    <td align="center"><table width="634" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtbumi"></label>
	                    ...
	                    <input name="txtbumi" type="text" id="txtbumi" />
      ...
      <tr>
        ...
        <td><label for=""><span id="sprytxtkdDarah">
              <input name="txtkdDarah" type="text" id="txtkdDarah" />
                        <span class="textfieldRequiredMsg">*Wajib diisi.</span></span></label></td>
	                  </tr>
      <tr>
        <td>&nbsp;</td>
...
<input type="hidden" name="MM_insert" value="frmDarah" />
		      </form>
          </div>
	      </div>
</div>
