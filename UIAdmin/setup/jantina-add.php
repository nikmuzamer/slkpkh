...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmJantina")) {
  $insertSQL = sprintf("INSERT INTO t109kod_jantina (f109kod, f109desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtjantina"></label>
	                    ...
	                    <input type="text" name="txtjantina" id="txtjantina" />
      ...
      <tr>
        ...
        <td><label for="txtkdjantina"><span id="txtsprykdjantina">
                        <input type="text" name="txtkdjantina" id="txtkdjantina" />
...
<input type="hidden" name="MM_insert" value="frmJantina" />
              </form>
	        </div>
	      </div>
</div>
