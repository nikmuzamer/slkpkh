...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmJawatan")) {
  $insertSQL = sprintf("INSERT INTO t109kod_jawatan (f109jawKod, f109jawDesc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="633" border="0">
      ...
      <tr>
        ...
        <td><label for="txtkdjawatan"><span id="txtsprykdjawatan">
              <input type="text" name="txtkdjawatan" id="txtkdjawatan" />
...
<input type="hidden" name="MM_insert" value="frmJawatan" />
              </form>
	        </div>
	      </div>
</div>
