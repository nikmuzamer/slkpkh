...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmNegerisemasa")) {
  $insertSQL = sprintf("INSERT INTO t109kod_negerisemasa (f109kdnegeri, f109desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="636" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtnsemasa"></label>
	                    ...
	                    <input type="text" name="txtnsemasa" id="txtnsemasa" />
      ...
      <tr>
        ...
        <td><label for="txtkdnsemasa"><span id="txtsprykdnsemasa">
                        <input type="text" name="txtkdnsemasa" id="txtkdnsemasa" />
...
<input type="hidden" name="MM_insert" value="frmNegerisemasa" />
              </form>
	        </div>
	      </div>
</div>
