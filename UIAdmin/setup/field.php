...
$query_rsFields = "SELECT * FROM t109kod_fields";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="field-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Fields</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Fields</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Fields</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsFields['f109fieldsDesc']; ?></td>
                          <td class="center">
                          
                          <a href="field-add.php"></a>
                        
                           <a href="field-edit.php?ID=<?php echo $row_rsFields['f109fieldsID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="field-delete.php?ID=<?php echo $row_rsFields['f109fieldsID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsFields = mysql_fetch_assoc($rsFields)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
