...
$colname_rsSebabcacat = "-1";
if (isset($_GET['ID'])) {
  $colname_rsSebabcacat = $_GET['ID'];
}
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsSebabcacat = sprintf("SELECT * FROM t109kod_sebabcacat WHERE f109SebabCacatID = %s", GetSQLValueString($colname_rsSebabcacat, "int"));
  ...
  <hr />
    ...
    <div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form name="frmSebabcacat" id="frmSebabcacat" method="POST">
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtsebabcacat"></label>
	                    ...
	                    <input name="txtsebabcacat" type="text" id="txtsebabcacat" value="<?php echo $row_rsSebabcacat['f109SebabCacatDesc']; ?>" />
      ...
      <tr>
        ...
        <td><label for="txtkdsebabcacat"><span id="txtsprykdsebabcacat">
                        <input name="txtkdsebabcacat" type="text" id="txtkdsebabcacat" value="<?php echo $row_rsSebabcacat['f109sebabCacatKod']; ?>" />
      ...
      <tr>
        ...
        <td><input type="submit" name="btnSave" id="btnSave" value="kemaskini" />
	                    <input name="txtIDsebabcacat" type="hidden" id="txtIDsebabcacat" value="<?php echo $row_rsSebabcacat['f109SebabCacatID']; ?>" /></td>
	                  </tr>
	                </table></td>
	              </tr>
	            </table>
