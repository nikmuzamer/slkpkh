...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsJenisAhli = "SELECT * FROM t109kod_jenisahli";
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form name="frmJenisAhli" id="frmJenisAhli" method="POST">
