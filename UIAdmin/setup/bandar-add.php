...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmAgama")) {
  $insertSQL = sprintf("INSERT INTO t109kod_bandar (CityCd, City) VALUES (%s, %s)",
                       GetSQLValueString($_POST['txtbandar'], "text"),
                       GetSQLValueString($_POST['txtkdbandar'], "text"));

  mysql_select_db($database_sqlconn, $sqlconn);
  $Result1 = mysql_query($insertSQL, $sqlconn) or die(mysql_error());

  $insertGoTo = "bandar.php";
  if (isset($_SERVER['QUERY_STRING'])) {
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form action="<?php echo $editFormAction; ?>" name="frmAgama" id="frmBAndar" method="POST">
<table width="643" height="70">
  <tr>
    <td><strong>INFO:</strong></td>
	              </tr>
  <tr>
    <td><em>*Tambah Bandar</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
  <tr>
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtbandar"></label>
          <span id="txtsprybandar">
          <label for="txtbandar"></label>
...
<label for="txtBahasa"></label></td>
      ...
      <tr>
        ...
        <td><label for="txtkdbandar"></label>
          <span id="txtsprykdbandar">
                          <label for="txtkdbandar"></label>
                          <input type="text" name="txtkdbandar" id="txtkdbandar" />
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("txtsprybandar");
var sprytextfield2 = new Spry.Widget.ValidationTextField("txtsprykdbandar", "integer");
</script>
</body>
</html>
<?php
