	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form name="frmUpdate" id="frmInsert" method="POST">
        ...
        <td width="473" bgcolor="#E7E4E6">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td class="center"><label>
                          <input name="txtKodJawatan" type="text" id="txtKodJawatan" value="<?php echo $row_rsJawatan['jawatanKod']; ?>" />
                        </label></td>
                      </tr>
                      <tr>
                        <td height="19"><div align="right"><strong>Nama Jawatan  :</strong></div></td>
                        <td class="center"><input name="txtNamaJawatan" type="text" id="txtNamaJawatan" value="<?php echo $row_rsJawatan['jawatanDesc']; ?>" size="50" /></td>
                      </tr>
                      <tr>
                        <td height="19"><div align="right"><strong>Gred Jawatan  :</strong></div></td>
                        <td class="center"><input name="txtGredJawatan" type="text" id="txtGredJawatan" value="<?php echo $row_rsJawatan['jawatanGred']; ?>" /></td>
                      </tr>
                      <tr>
                        <td height="19"><div align="right"><strong>kategori Jawatan  :</strong></div></td>
                        <td class="center"><label>
                          <select name="cmbKategori" id="cmbKategori" title="<?php echo $row_rsJawatan['jawatanStatus']; ?>">
                      ...
                      <tr>
                        ...
                        <td class="center"><select name="cmbStatus" id="cmbStatus" title="<?php echo $row_rsJawatan['displayStatus']; ?>">
                          <option value="-1" selected="selected">--Sila Pilih--</option>
                      ...
                      <tr>
                        <td height="19">&nbsp;</td>
                        <td class="center"><label>
                          <input type="submit" name="txtSimpan" id="txtSimpan" value="Delete" />
                        </label></td>
                      </tr>
                    </table></td>
	              </tr>
