...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="peringkat-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Peringkat</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Peringkat</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Peringkat</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsPeringkat['f109keterangan']; ?></td>
                          <td class="center">
                          
                         <a href="peringkat-add.php"></a>
                          
                         <a href="peringkat-edit.php?ID=<?php echo $row_rsPeringkat['f109IDperingkat']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="peringkat-delete.php?ID=<?php echo $row_rsPeringkat['f109IDperingkat']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsPeringkat = mysql_fetch_assoc($rsPeringkat)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
