...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frmAnugerahOleh")) {
  $updateSQL = sprintf("UPDATE t109kod_anugeraholeh SET CfdByCd=%s, CfdBy=%s WHERE CfdByID=%s",
                       GetSQLValueString($_POST['textkdAnugerah'], "text"),
                       GetSQLValueString($_POST['textAnugerah'], "text"),
...
$colname_rsAnugerahOleh = "-1";
if (isset($_GET['ID'])) {
  $colname_rsAnugerahOleh = $_GET['ID'];
}
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsAnugerahOleh = sprintf("SELECT * FROM t109kod_anugeraholeh WHERE CfdByID = %s", GetSQLValueString($colname_rsAnugerahOleh, "int"));
$rsAnugerahOleh = mysql_query($query_rsAnugerahOleh, $sqlconn) or die(mysql_error());
$row_rsAnugerahOleh = mysql_fetch_assoc($rsAnugerahOleh);
$totalRows_rsAnugerahOleh = mysql_num_rows($rsAnugerahOleh);
...
<script src="../../JavascriptFiles/sortableTable.js" type="text/javascript"></script><script language="JavaScript" type="text/JavaScript">
...
<div id="wrapper">
  ...
  <hr />
	...
	<div id="page-bgtop">
	  <div id="content">
		  <div class="post">
		    <h2 class="title"><a href="#" class="title">Konfigurasi Anugerah Oleh</a></h2>
		    <p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Thursday, 4 October, 2012 3:56 PM<!-- #EndDate -->
				</p>
		    <div class="entry">
		      <form action="<?php echo $editFormAction; ?>" name="frmAnugerahOleh" id="frmAnugerahOleh" method="POST">
<table width="643" height="70">
  <tr>
    <td><strong>INFO:</strong></td>
	              </tr>
  <tr>
    <td><em>*Kemaskini Anugerah Oleh</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
  <tr>
    <td align="center"><table width="635" border="0">
      <tr>
        <td width="26%"><div align="right"><strong>Nama Anugerah Oleh: </strong></div></td>
        <td width="74%"><label for="textAnugerah"></label>
	                    <input name="textAnugerah" type="text" id="textAnugerah" value="<?php echo $row_rsAnugerahOleh['CfdBy']; ?>" size="30" />          
	                    <label for="txtagama"></label></td>
	                  </tr>
      <tr>
        <td><div align="right"><strong>Kod Anugerah Oleh:</strong></div></td>
        <td><label for="textkdAnugerah"></label>
	                    <input name="textkdAnugerah" type="text" id="textkdAnugerah" value="<?php echo $row_rsAnugerahOleh['CfdByCd']; ?>" /></td>
	                  </tr>
      <tr>
        <td>&nbsp;</td>
        <td><input type="submit" name="btnSave" id="btnSave" value="kemaskini" />
	                    <input name="hidnID" type="hidden" id="hidnID" value="<?php echo $row_rsAnugerah['AnugerahID']; ?>" /></td>
	                  </tr>
	                </table></td>
	              </tr>
	            </table>
...
<input type="hidden" name="MM_update" value="frmAnugerahOleh" />
              </form>
            </div>
	      </div>
</div>
...
mysql_free_result($rsAnugerahOleh);
?>
