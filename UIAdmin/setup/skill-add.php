...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmSkill")) {
  $insertSQL = sprintf("INSERT INTO t109kod_skill (f109kdskill, f109keterangan) VALUES (%s, %s)",
    ...
    <td align="center"><table width="200" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtskill"></label>
	                    ...
	                    <input type="text" name="txtskill" id="txtskill" />
      ...
      <tr>
        ...
        <td><label for="txtkdskill"><span id="txtsprykdskill">
                        <input type="text" name="txtkdskill" id="txtkdskill" />
...
<input type="hidden" name="MM_insert" value="frmSkill" />
              </form>
	        </div>
	      </div>
</div>
