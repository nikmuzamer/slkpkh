...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmNegerilahir")) {
  $insertSQL = sprintf("INSERT INTO t109kod_nlahir (f109kdnegeri, f109keterangan) VALUES (%s, %s)",
...
<table width="643" height="70">
  ...
  <tr>
    <td><em>*Tambah Negeri Lahir</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
    ...
    <td align="center"><table width="200" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtnlahir"></label>
	                    ...
	                    <input type="text" name="txtnlahir" id="txtnlahir" />
      ...
      <tr>
        ...
        <td><label for="txtkdnlahir"><span id="txtsprykdnlahir">
                        <input type="text" name="txtkdnlahir" id="txtkdnlahir" />
...
<input type="hidden" name="MM_insert" value="frmNegerilahir" />
              </form>
	        </div>
	      </div>
</div>
