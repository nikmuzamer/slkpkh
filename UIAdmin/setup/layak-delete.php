...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsLayak = sprintf("SELECT * FROM t109kod_layak WHERE f109id = %s", GetSQLValueString($colname_rsLayak, "text"));
...
<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form name="frmLayak" id="frmLayak" method="POST">
    ...
    <td align="center"><table width="633" border="0">
      ...
      <tr>
        ...
        <td><input type="submit" name="btnSave" id="btnSave" value="kemaskini" />
	                    <input name="txtIDlayak" type="hidden" id="txtIDlayak" value="<?php echo $row_rsLayak['f109id']; ?>" /></td>
	                  </tr>
	                </table></td>
	              </tr>
	            </table>
