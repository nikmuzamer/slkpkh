...
$query_rsNegerisemasa = "SELECT * FROM t109kod_negerisemasa";
...
<table width="643" height="123">
  ...
  <tr>
    <td><em>*Kemaskini Negeri Semasa</em></td>
	              </tr>
  <tr>
    <td><a href="negerisemasa-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Negeri Semasa</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Negeri Semasa</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Negeri Semasa</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsNegerisemasa['f109desc']; ?></td>
                          <td class="center">
                          
                          <a href="negerisemasa-add.php"></a>
                         
                         <a href="negerisemasa-edit.php?ID=<?php echo $row_rsNegerisemasa['f109IDnegeri']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="negerisemasa-delete.php?ID= <?php echo $row_rsNegerisemasa['f109IDnegeri']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsNegerisemasa = mysql_fetch_assoc($rsNegerisemasa)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
