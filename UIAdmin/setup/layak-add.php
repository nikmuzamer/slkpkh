...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmLayak")) {
  $insertSQL = sprintf("INSERT INTO t109kod_layak (f109kod, f109desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="633" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtlayak"></label>
	                    ...
	                    <input type="text" name="txtlayak" id="txtlayak" />
      ...
      <tr>
        ...
        <td><label for="txtkdlayak"><span id="txtsprykdlayak">
                        <input type="text" name="txtkdlayak" id="txtkdlayak" />
...
<input type="hidden" name="MM_insert" value="frmLayak" />
              </form>
	        </div>
	      </div>
</div>
