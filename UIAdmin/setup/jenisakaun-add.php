...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmJenisAkaun")) {
  $insertSQL = sprintf("INSERT INTO t109kod_jenisacc (AccTypeCd, AccType) VALUES (%s, %s)",
...
<input type="hidden" name="MM_insert" value="frmJenisAkaun" />
		      </form>
	        </div>
	      </div>
</div>
