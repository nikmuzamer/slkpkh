...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmExam")) {
  $insertSQL = sprintf("INSERT INTO t109kod_exam (f109examKod, f109examDesc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtexam"></label>
          ...
          <input type="text" name="txtexam" id="txtexam" />
      ...
      <tr>
        ...
        <td><label for="txtkdexam"></label>
          <span id="txtsprykdexam">
                          ...
                          <input type="text" name="txtkdexam" id="txtkdexam" />
...
<input type="hidden" name="MM_insert" value="frmExam" />
              </form>
	        </div>
	      </div>
</div>
