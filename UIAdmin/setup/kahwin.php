...
$query_rsKahwin = "SELECT * FROM t109kod_kahwin";
...
<table width="643" height="123">
  ...
  <tr>
    <td><em>*Kemaskini Taraf Perkahwinan</em></td>
	              </tr>
  <tr>
    <td><a href="kahwin-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Taraf Perkahwinan</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Taraf Perkahwinan</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Taraf Perkahwinan</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsKahwin['f109desc']; ?></td>
                          <td class="center">
                          
                          <a href="kahwin-add.php"></a>
                          
                          <a href="kahwin-edit.php?ID=<?php echo $row_rsKahwin['f109id']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="kahwin-delete.php?ID=<?php echo $row_rsKahwin['f109id']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsKahwin = mysql_fetch_assoc($rsKahwin)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
