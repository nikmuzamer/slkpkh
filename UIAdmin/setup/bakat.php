...
$query_rsbakat = "SELECT * FROM t109kod_bakat";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="bakat-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Bakat</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Bakat</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Bakat</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
      <?php do { ?>
        <tr>
          <td><?php echo $row_rsbakat['f109desc']; ?></td>
          <td class="center">
                          
                          <a href="bakat-add.php"></a>
                          
                          <a href="bakat-edit.php?ID=<?php echo $row_rsbakat['f109IDbakat']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="bakat-delete.php?ID=<?php echo $row_rsbakat['f109IDbakat']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
	                    </tr>
        <?php } while ($row_rsbakat = mysql_fetch_assoc($rsbakat)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
