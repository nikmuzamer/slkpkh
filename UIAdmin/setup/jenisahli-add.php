...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmJenisAhli")) {
  $insertSQL = sprintf("INSERT INTO t109kod_jenisahli (MembershipTypeCd, MembershipType) VALUES (%s, %s)",
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtJenisAhli"></label>
          ...
          <input type="text" name="txtJenisAhli" id="txtJenisAhli" />
      ...
      <tr>
        ...
        <td><label for="txtkdJenisAhli"></label>
          <span id="txtsprykdJenisAhli">
                          ...
                          <input type="text" name="txtkdJenisAhli" id="txtkdJenisAhli" />
...
<input type="hidden" name="MM_insert" value="frmJenisAhli" />
		      </form>
	        </div>
	      </div>
</div>
