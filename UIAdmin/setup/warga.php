...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsWarga = "SELECT * FROM t109kod_warga";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="warga-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Warga</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Warga</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Warga</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsWarga['f109keterangan']; ?></td>
                          <td class="center">
                          
                          <a href="warga-add.php"></a>
                          
                         <a href="warga-edit.php?ID=<?php echo $row_rsWarga['f109wargaid']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="warga-delete.php?ID=<?php echo $row_rsWarga['f109wargaid']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsWarga = mysql_fetch_assoc($rsWarga)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
