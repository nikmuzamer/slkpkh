...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsAgama = "SELECT * FROM t109kod_agama";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="agama-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Agama</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Agama</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Agama</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
					  <?php do { ?>
                      <tr>
                          <td><?php echo $row_rsAgama['f761desc']; ?></td>
                          <td class="center">
                          
                          <a href="agama-add.php"></a>
                          
                          <a href="agama-edit.php?ID=<?php echo $row_rsAgama['f761agama']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="agama-delete.php?ID=<?php echo $row_rsAgama['f761agama']; ?>"" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>    
                      </tr>
					  <?php } while ($row_rsAgama = mysql_fetch_assoc($rsAgama)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
