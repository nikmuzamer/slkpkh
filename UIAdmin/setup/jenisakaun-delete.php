	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form name="frmJenisAkaun" id="frmJenisAkaun" method="POST">
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtJenisAkaun"></label>
          ...
          <input type="text" name="txtJenisAkaun" id="txtJenisAkaun" />
      ...
      <tr>
        ...
        <td><label for="txtkdJenisAkaun"></label>
          <span id="txtsprykdJenisAkaun">
                          ...
                          <input type="text" name="txtkdJenisAkaun" id="txtkdJenisAkaun" />
