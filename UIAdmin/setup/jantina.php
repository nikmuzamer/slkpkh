...
$query_rsJantina = "SELECT * FROM t109kod_jantina";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="jantina-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Jantina</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Jantina</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Jantina</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsJantina['f109desc']; ?></td>
                          <td class="center">
                          
                          <a href="jantina-add.php"></a>
                          
                           <a href="jantina-edit.php?ID=<?php echo $row_rsJantina['f109id']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="jantina-delete.php?ID=<?php echo $row_rsJantina['f109id']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsJantina = mysql_fetch_assoc($rsJantina)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
