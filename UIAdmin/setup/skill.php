...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsSkill = "SELECT * FROM t109kod_skill";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="skill-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Skill</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Skill</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Skill</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsSkill['f109keterangan']; ?></td>
                          <td class="center">
                          
                          <a href="skill-add.php"></a>
                          
                         <a href="skill-edit.php?ID=<?php echo $row_rsSkill['f109skillID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="skill-delete.php?ID=<?php echo $row_rsSkill['f109skillID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsSkill = mysql_fetch_assoc($rsSkill)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
