...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmField")) {
  $insertSQL = sprintf("INSERT INTO t109kod_fields (f109fieldsKod, f109fieldsDesc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="636" border="0">
      ...
      <tr>
        ...
        <td><label for="txtkdfield"><span id="txtsprykdfield">
                        <input type="text" name="txtkdfield" id="txtkdfield" />
...
<input type="hidden" name="MM_insert" value="frmField" />
              </form>
	        </div>
	      </div>
</div>
