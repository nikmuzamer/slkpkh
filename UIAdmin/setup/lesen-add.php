...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmLesen")) {
  $insertSQL = sprintf("INSERT INTO t109kod_lesen (f109kodlesen, f109kelaslesen) VALUES (%s, %s)",
    ...
    <td align="center"><table width="637" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtlesen"></label>
	                    ...
	                    <input type="text" name="txtlesen" id="txtlesen" />
...
*Wajib diisi.</span></span></label></td>
      ...
      <tr>
        ...
        <td><label for="txtkdlesen"><span id="txtsprykdlesen">
                        <input type="text" name="txtkdlesen" id="txtkdlesen" />
                        <span class="textfieldRequiredMsg">
