...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmBangsa")) {
  $insertSQL = sprintf("INSERT INTO t109kod_bangsa (f109kod, f109desc) VALUES (%s, %s)",
                       GetSQLValueString($_POST['txtkdbangsa'], "text"),
                       GetSQLValueString($_POST['txtbangsa'], "text"));

  mysql_select_db($database_sqlconn, $sqlconn);
  $Result1 = mysql_query($insertSQL, $sqlconn) or die(mysql_error());

  $insertGoTo = "bangsa.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <hr />
	...
	<div id="page-bgtop">
      ...
      <div class="post">
		    ...
		    <div class="entry">
		      <form action="<?php echo $editFormAction; ?>" name="frmBangsa" id="frmBangsa" method="POST">
<table width="643" height="70">
  <tr>
    <td><strong>INFO:</strong></td>
	              </tr>
  <tr>
    <td><em>*Tambah Bangsa</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
    ...
    <td align="center"><table width="634" border="0">
      ...
      <tr>
        ...
        <td><label for=""><span id="txtsprykdbangsa">
                        <input type="text" name="txtkdbangsa" id="txtkdbangsa" />
...
<input type="hidden" name="MM_insert" value="frmBangsa" />
              </form>
	        </div>
	      </div>
</div>
