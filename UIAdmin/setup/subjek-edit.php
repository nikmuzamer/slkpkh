...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frmSubjek")) {
  $updateSQL = sprintf("UPDATE t109kod_subjek SET f109kdsubjek=%s, f109keterangan=%s WHERE f109IDsubjek=%s",
                       GetSQLValueString($_POST['txtkdsubjek'], "text"),
                       GetSQLValueString($_POST['txtsubjek'], "text"),
                       GetSQLValueString($_POST['txtIDsubjek'], "int"));

  mysql_select_db($database_sqlconn, $sqlconn);
  $Result1 = mysql_query($updateSQL, $sqlconn) or die(mysql_error());

  $updateGoTo = "subjek.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_rsSubjek = "-1";
if (isset($_GET['ID'])) {
  $colname_rsSubjek = $_GET['ID'];
}
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsSubjek = sprintf("SELECT * FROM t109kod_subjek WHERE f109IDsubjek = %s", GetSQLValueString($colname_rsSubjek, "int"));
...
<div id="wrapper">
  ...
  <hr />
    ...
    <div id="content">
		  <div class="post">
		    <h2 class="title"><a href="#" class="title">Konfigurasi Subjek</a></h2>
		    <p class="meta">Kemaskini terakhir pada  
			  <!-- #BeginDate format:fcSw1a -->Thursday, 4 October, 2012 4:36 PM<!-- #EndDate -->
			</p>
		    <div class="entry">
		      <form action="<?php echo $editFormAction; ?>" name="frmSubjek" id="frmSubjek" method="POST">
<table width="643" height="70">
  <tr>
    <td><strong>INFO:</strong></td>
	              </tr>
  <tr>
    <td><em>*Tambah Subjek</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
  <tr>
    <td align="center"><table width="200" border="0">
      <tr>
        <td width="26%"><div align="right"><strong>NamaSubjek: </strong></div></td>
        <td width="74%"><label for="txtsubjek"></label>
	                    <label for="txtBahasa"><span id="txtsprysubjek">
	                    <input name="txtsubjek" type="text" id="txtsubjek" value="<?php echo $row_rsSubjek['f109keterangan']; ?>" />
	                    <span class="textfieldRequiredMsg">*Wajib diisi.</span></span></label></td>
	                  </tr>
      <tr>
        <td><div align="right"><strong>Kod Subjek:</strong></div></td>
        <td><label for="txtkdsubjek"><span id="txtsprykdsubjek">
                        <input name="txtkdsubjek" type="text" id="txtkdsubjek" value="<?php echo $row_rsSubjek['f109kdsubjek']; ?>" />
      ...
      <tr>
        ...
        <td><input type="submit" name="btnSave" id="btnSave" value="Simpan" />
	                    <input name="txtIDsubjek" type="hidden" id="txtIDsubjek" value="<?php echo $row_rsSubjek['f109IDsubjek']; ?>" /></td>
	                  </tr>
	                </table></td>
	              </tr>
	            </table>
...
<input type="hidden" name="MM_update" value="frmSubjek" />
</form>
	        </div>
	      </div>
</div>
...
<script type="text/javascript">
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("txtsprysubjek");
var sprytextfield2 = new Spry.Widget.ValidationTextField("txtsprykdsubjek", "integer");
//-->
</script>
</body>
</html>
