...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsExam = "SELECT * FROM t109kod_exam";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="exam-add.php"><img src="../../images/database-add-icon.png" alt="tambah" width="16" height="16" />-Tambah Exam</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Exam</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Exam</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsExam['f109examDesc']; ?></td>
                          <td class="center">
                          
                          <a href="exam-add.php"></a>
                          
                          <a href="exam-edit.php?ID=<?php echo $row_rsExam['f109examID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="exam-delete.php?ID=<?php echo $row_rsExam['f109examID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsExam = mysql_fetch_assoc($rsExam)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
