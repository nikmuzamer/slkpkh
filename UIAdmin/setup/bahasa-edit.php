...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frmBahasa")) {
  $updateSQL = sprintf("UPDATE t109kod_bahasa SET LangCd=%s, Lang=%s WHERE LangID=%s",
                       GetSQLValueString($_POST['txtkdbahasa'], "text"),
                       GetSQLValueString($_POST['txtbahasa'], "text"),
                       GetSQLValueString($_POST['txtIDbahasa'], "int"));

  mysql_select_db($database_sqlconn, $sqlconn);
  $Result1 = mysql_query($updateSQL, $sqlconn) or die(mysql_error());

  $updateGoTo = "bahasa.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="wrapper">
  ...
  <hr />
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    <h2 class="title"><a href="#" class="title">Konfigurasi Bahasa</a></h2>
		    <p class="meta">Kemaskini terakhir pada  
			  <!-- #BeginDate format:fcSw1a -->Thursday, 4 October, 2012 4:08 PM<!-- #EndDate -->
			</p>
		    <div class="entry">
		      <form action="<?php echo $editFormAction; ?>" name="frmBahasa" id="frmBahasa" method="POST">
<table width="643" height="70">
  <tr>
    <td><strong>INFO:</strong></td>
	              </tr>
  <tr>
    <td><em>*Kemaskini Bahasa</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
  <tr>
    <td align="center"><table width="634" border="0">
      <tr>
        <td width="26%"><div align="right"><strong>Nama Bahasa: </strong></div></td>
        <td width="74%"><label for="txtbahasa"></label>
	                    <label for="txtBahasa"><span id="txtsprybahasa">
	                    <input name="txtbahasa" type="text" id="txtbahasa" value="<?php echo $row_rsBahasa['Lang']; ?>" />
	                    <span class="textfieldRequiredMsg">*Wajib diisi.</span></span></label></td>
	                  </tr>
      <tr>
        <td><div align="right"><strong>Kod Bahasa:</strong></div></td>
        <td><label for="txtkdbahasa"><span id="txtsprykdbahasa">
                        <input name="txtkdbahasa" type="text" id="txtkdbahasa" value="<?php echo $row_rsBahasa['LangCd']; ?>" />
      ...
      <tr>
        ...
        <td><input type="submit" name="btnSave" id="btnSave" value="kemaskini" />
	                    <input name="txtIDbahasa" type="hidden" id="txtIDbahasa" value="<?php echo $row_rsBahasa['f109IDbahasa']; ?>" /></td>
	                  </tr>
	                </table></td>
	              </tr>
	            </table>
...
<input type="hidden" name="MM_update" value="frmBahasa" />
</form>
	        </div>
	      </div>
</div>
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("txtsprybahasa");
var sprytextfield2 = new Spry.Widget.ValidationTextField("txtsprykdbahasa", "integer");
</script>
</body>
</html>
<?php
