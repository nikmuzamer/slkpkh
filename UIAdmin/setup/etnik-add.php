...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmEtnik")) {
  $insertSQL = sprintf("INSERT INTO t109kod_etnik (EthnicCd, Ethnic) VALUES (%s, %s)",
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form action="<?php echo $editFormAction; ?>" name="frmEtnik" id="frmEtnik" method="POST">
    ...
    <td align="center"><table width="634" border="0">
      <tr>
        ...
        <td width="74%"><label for=""></label>
	                    <label for="txtBahasa"><span id="txtspryetnik">
	                      <input name="txtetnik" type="text" id="txtetnik" size="40" />
      ...
      <tr>
        ...
        <td><label for="txtkdetnik"><span id="txtsprykdetnik">
                        <input name="txtkdetnik" type="text" id="txtkdetnik" />
...
<input type="hidden" name="MM_insert" value="frmEtnik" />
</form>
	        </div>
	      </div>
</div>
