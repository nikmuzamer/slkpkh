...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsNegerilahir = "SELECT * FROM t109kod_nlahir";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="negerilahir-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Negeri Lahir</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Negeri Lahir</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Negeri Lahir</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsNegerilahir['f109keterangan']; ?></td>
                          <td class="center">
                          
                       <a href="negerilahir-add.php"></a>
                          
                           <a href="negerilahir-edit.php?ID=<?php echo $row_rsNegerilahir['f109IDnegeri']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="negerilahir-delete.php?ID=<?php echo $row_rsNegerilahir['f109IDnegeri']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsNegerilahir = mysql_fetch_assoc($rsNegerilahir)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
