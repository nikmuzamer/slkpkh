...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmKahwin")) {
  $insertSQL = sprintf("INSERT INTO t109kod_kahwin (f109kod, f109desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtkahwin"></label>
	                    ...
	                    <input type="text" name="txtkahwin" id="txtkahwin" />
      ...
      <tr>
        ...
        <td><label for="txtkdkahwin"><span id="txtsprykdkahwin">
                        <input type="text" name="txtkdkahwin" id="txtkdkahwin" />
...
<input type="hidden" name="MM_insert" value="frmKahwin" />
              </form>
	        </div>
	      </div>
</div>
