...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frmAnugerah")) {
  $updateSQL = sprintf("UPDATE t109kod_anugerah SET AwdCd=%s, Awd=%s WHERE AnugerahID=%s",
...
$colname_rsAnugerah = "-1";
if (isset($_GET['ID'])) {
  $colname_rsAnugerah = $_GET['ID'];
}
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsAnugerah = sprintf("SELECT * FROM t109kod_anugerah WHERE AnugerahID = %s", GetSQLValueString($colname_rsAnugerah, "int"));
$rsAnugerah = mysql_query($query_rsAnugerah, $sqlconn) or die(mysql_error());
$row_rsAnugerah = mysql_fetch_assoc($rsAnugerah);
$totalRows_rsAnugerah = mysql_num_rows($rsAnugerah);
	...
	<div id="page-bgtop">
	  <div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form action="<?php echo $editFormAction; ?>" name="frmAnugerah" id="frmAnugerah" method="POST">
<table width="643" height="70">
  ...
  <tr>
    <td align="center"><table width="635" border="0">
      <tr>
        <td width="26%"><div align="right"><strong>Nama Anugerah: </strong></div></td>
        <td width="74%"><label for="textAnugerah"></label>
	                    <input name="textAnugerah" type="text" id="textAnugerah" value="<?php echo $row_rsAnugerah['Awd']; ?>" size="60" />          
	                    <label for="txtagama"></label></td>
	                  </tr>
      <tr>
        <td><div align="right"><strong>Kod Anugerah:</strong></div></td>
        <td><label for="textkdAnugerah"></label>
	                    <input name="textkdAnugerah" type="text" id="textkdAnugerah" value="<?php echo $row_rsAnugerah['AwdCd']; ?>" /></td>
	                  </tr>
      <tr>
        <td>&nbsp;</td>
...
<input type="hidden" name="MM_update" value="frmAnugerah" />
              </form>
            </div>
	      </div>
</div>
