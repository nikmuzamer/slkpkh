...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmFakulti")) {
  $insertSQL = sprintf("INSERT INTO t109kod_faculty (f109facultyKod, f109facultyDesc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtfakulti"></label>
	                    <label for="txtBahasa"><span id="txtspryfakulti">
	                      <input type="text" name="txtfakulti" id="txtfakulti" />
      ...
      <tr>
        ...
        <td><label for="txtkdfakulti"><span id="txtsprykdfakulti">
                        <input type="text" name="txtkdfakulti" id="txtkdfakulti" />
...
<input type="hidden" name="MM_insert" value="frmFakulti" />
              </form>
	        </div>
	      </div>
</div>
