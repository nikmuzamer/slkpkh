...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmPeringkat")) {
  $insertSQL = sprintf("INSERT INTO t109kod_peringkat (f109kdperingkat, f109keterangan) VALUES (%s, %s)",
    ...
    <td align="center"><table width="200" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtperingkat"></label>
	                    ...
	                    <input type="text" name="txtperingkat" id="txtperingkat" />
      ...
      <tr>
        ...
        <td><label for="txtkdperingkat"><span id="txtsprykdperingkat">
                        <input type="text" name="txtkdperingkat" id="txtkdperingkat" />
...
<input type="hidden" name="MM_insert" value="frmPeringkat" />
              </form>
	        </div>
	      </div>
</div>
