...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmTrengkas")) {
  $insertSQL = sprintf("INSERT INTO t109kod_trengkas (f109trengkasKod, f109trengkasDesc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="200" border="0">
      <tr>
        ...
        <td width="74%"><label for="txttrengkas"></label>
	                    ...
	                    <input type="text" name="txttrengkas" id="txttrengkas" />
      ...
      <tr>
        ...
        <td><label for="txtkdtrengkas"><span id="txtsprykdtrengkas">
                        <input type="text" name="txtkdtrengkas" id="txtkdtrengkas" />
...
<input type="hidden" name="MM_insert" value="frmTrengkas" />
              </form>
	        </div>
	      </div>
</div>
