...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmBidang")) {
  $insertSQL = sprintf("INSERT INTO t109kod_bidang (f109kod, f109desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="200" border="0">
      <tr>
        ...
        <td width="74%"><label for=""></label>
	                    <label for="txtBahasa"><span id="txtsprybidang">
	                      <input type="text" name="txtbidang" id="txtbidang" />
      ...
      <tr>
        ...
        <td><label for="txtkdbidang"><span id="txtsprykdbidang">
                        <input type="text" name="txtkdbidang" id="txtkdbidang" />
...
<input type="hidden" name="MM_insert" value="frmBidang" />
              </form>
	        </div>
	      </div>
</div>
