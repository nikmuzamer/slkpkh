...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmSubjek")) {
  $insertSQL = sprintf("INSERT INTO t109kod_subjek (f109kdsubjek, f109keterangan) VALUES (%s, %s)",
    ...
    <td align="center"><table width="200" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtsubjek"></label>
	                    ...
	                    <input type="text" name="txtsubjek" id="txtsubjek" />
      ...
      <tr>
        ...
        <td><label for="txtkdsubjek"><span id="txtsprykdsubjek">
                        <input type="text" name="txtkdsubjek" id="txtkdsubjek" />
...
<input type="hidden" name="MM_insert" value="frmSubjek" />
              </form>
	        </div>
	      </div>
</div>
