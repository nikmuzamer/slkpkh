...
$query_rsLesen = "SELECT * FROM t109kod_lesen";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="lesen-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Lesen</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Lesen</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Lesen</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
                      ...
                      <?php do { ?>
                        <tr>
                          ...
                          <a href="lesen-add.php"></a>
                          
                          <a href="lesen-edit.php?ID=<?php echo $row_rsLesen['f109IDlesen']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a>
                          
                          <a href="lesen-delete.php?ID=<?php echo $row_rsLesen['f109IDlesen']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
