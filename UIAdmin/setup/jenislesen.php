...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsJenisLesen = "SELECT * FROM t109kod_jenislesen";
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form id="form1" method="post" action="bakat.php">
<table width="643" height="123">
  ...
  <tr>
    <td><a href="jenislesen-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Jenis Lesen</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Jenis Lesen</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Jenis Lesen</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsJenisLesen['LicType']; ?></td>
                          <td class="center"><a href="bakat-add.php"></a> 
                            
                            <a href="jenislesen-edit.php?ID=<?php echo $row_rsJenisLesen['jenislesenID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a> 
                            
                            <a href="../../Administrator/setup/jenislesen-delete.php?ID=<?php echo $row_rsJenisLesen['jenislesenID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsJenisLesen = mysql_fetch_assoc($rsJenisLesen)); ?>
</table></td>
	              </tr>
	            </table>
