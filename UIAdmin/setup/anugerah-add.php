...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmAnugerah")) {
  $insertSQL = sprintf("INSERT INTO t109kod_anugerah (AwdCd, Awd) VALUES (%s, %s)",
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="textAnugerah"></label>
	                    <label for="txtagama"><span id="sprytextAnugerah">
	                      <input name="textAnugerah" type="text" id="textAnugerah" size="60" />
                        <span class="textfieldRequiredMsg">*Wajib diisi.</span></span></label></td>
	                  </tr>
      <tr>
        <td><div align="right"><strong>Kod Anugerah:</strong></div></td>
        <td><label for="textkdAnugerah"><span id="sprytextkdAnugerah">
                        <input type="text" name="textkdAnugerah" id="textkdAnugerah" />
...
<input type="hidden" name="MM_insert" value="frmAnugerah" />
              </form>
            </div>
	      </div>
</div>
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextAnugerah");
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextkdAnugerah", "integer");
</script>
</body>
</html>
<?php
