...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmFWarga")) {
  $insertSQL = sprintf("INSERT INTO t109kod_warga (f109kdwarga, f109keterangan) VALUES (%s, %s)",
    ...
    <td align="center"><table width="635" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtwarga"></label>
	                    ...
	                    <input type="text" name="txtwarga" id="txtwarga" />
      ...
      <tr>
        ...
        <td><label for="txtkdwarga"><span id="txtsprykdwarga">
              <input type="text" name="txtkdwarga" id="txtkdwarga" />
...
<input type="hidden" name="MM_insert" value="frmFWarga" />
              </form>
	        </div>
	      </div>
</div>
