...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmCacat")) {
  $insertSQL = sprintf("INSERT INTO t109kod_cacat (f109cacatKod, f109cacatDesc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="634" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtcacat"></label>
	                    <label for="txtBahasa"><span id="sprytextfield1">
	                      <input type="text" name="txtcacat" id="txtcacat" />
      ...
      <tr>
        ...
        <td><label for="txtkdcacat"><span id="txtsprykdcacat">
                        <input type="text" name="txtkdcacat" id="txtkdcacat" />
...
<input type="hidden" name="MM_insert" value="frmCacat" />
              </form>
	        </div>
	      </div>
</div>
