	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form name="frmBakat" id="frmBakat" method="POST">
<table width="643" height="70">
  ...
  <tr>
    <td align="center"><table width="629" border="0">
      <tr>
