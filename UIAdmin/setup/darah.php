...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsDarah = "SELECT * FROM t109kod_darah";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="darah-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Jenis Darah</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Jenis Darah</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Jenis Darah</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsDarah['f761desc']; ?></td>
                          <td class="center"><a href="bidang-add.php"></a> 
                          
                          <a href="darah-edit.php?ID= <?php echo $row_rsDarah['f761id']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a> 
                          
                          <a href="darah-delete.php?ID=<?php echo $row_rsDarah['f761id']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsDarah = mysql_fetch_assoc($rsDarah)); ?>
</table></td>
	              </tr>
	            </table>
<p>&nbsp;	            </p>
