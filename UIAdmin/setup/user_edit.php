...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "frmAdduser")) {
  $updateSQL = sprintf("UPDATE t142_akaun SET f142password=%s, f142email=%s, f142Name=%s, f142noIC=%s, f142idlevel=%s WHERE f142idakaun=%s",
...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsLevel = "SELECT * FROM t141_level ORDER BY f140idlevel";
...
if (isset($_GET['ID'])) {
  $colname_rsPengguna = $_GET['ID'];
}
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsPengguna = sprintf("SELECT * FROM t142_akaun WHERE f142idakaun = %s", GetSQLValueString($colname_rsPengguna, "int"));
	  ...
	  <div id="content">
        <div class="post">
          ...
          <p class="meta">Kemaskini terakhir pada
            <!-- #BeginDate format:fcSw1a -->Thursday, 4 October, 2012 4:36 PM<!-- #EndDate --></p>
          <div class="entry">
            <form action="<?php echo $editFormAction; ?>" name="frmAdduser" id="frmAdduser" method="POST">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td colspan="2"><span id="txtSprayICNo">
                    ...
                    <span id="txtspryICNo">
                    <label>
                    <input name="txtICNo" type="text" id="txtICNo" value="<?php echo $row_rsPengguna['f142noIC']; ?>" size="12" maxlength="12" />
                    </label>
                ...
                <tr>
                  ...
                  <td colspan="2"><span id="sprytextfield3"><span id="txtSprayNama">
                    ...
                    <span id="txtspryName">
                    <label>
                    <input name="txtName" type="text" id="txtName" onblur="f(this)" onclick="f(this)" onkeydown="f(this)" onkeyup="f(this)" value="<?php echo $row_rsPengguna['f142Name']; ?>" size="50"/>
                    </label>
                ...
                <tr>
                  ...
                  <td colspan="2"><span id="txtSprayEmail">
                    ...
                    <label>
                    <input name="txtEmail" type="text" id="txtEmail" value="<?php echo $row_rsPengguna['f142email']; ?>" size="50" />
                    </label>
            ...
            <td colspan="2"><span id="cmbSprayLevel">
                    ...
                    <select name="cmbLevel" id="cmbLevel" title="<?php echo $row_rsPengguna['f142idlevel']; ?>">
                      <option value="-1" selected="selected" <?php if (!(strcmp(-1, $row_rsLevel['f140level']))) {echo "selected=\"selected\"";} ?>>-Sila Pilih-</option>
                      <?php
do {  
?>
...
?>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="2"><label>
                    <input type="submit" name="btnDaftar" id="btnDaftar" value="Kemaskini Akaun" />
                    <input name="txtKodWarga" type="hidden" id="txtKodWarga" value="0" />
                    <input name="txtIDAkaun" type="hidden" id="txtIDAkaun" value="<?php echo $row_rsPengguna['f142idakaun']; ?>" />
                  </label></td>
                </tr>
              </table>
