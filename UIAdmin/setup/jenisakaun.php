...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsJenisAkaun = "SELECT * FROM t109kod_jenisacc";
...
<table width="643" height="123">
  ...
  <tr>
    <td><em>*Kemaskini Jenis Akaun</em></td>
	              </tr>
  <tr>
    <td><a href="jenisakaun-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Jenis Akaun</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Jenis Akaun</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Jenis Akaun</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsJenisAkaun['AccType']; ?></td>
                          <td class="center"><a href="bakat-add.php"></a> 
                            
                            <a href="jenisakaun-edit.php?ID=<?php echo $row_rsJenisAkaun['AccTypeID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a> 
                            
                            <a href="jenisakaun-delete.php?ID=<?php echo $row_rsJenisAkaun['AccTypeID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsJenisAkaun = mysql_fetch_assoc($rsJenisAkaun)); ?>
</table></td>
	              </tr>
	            </table>
