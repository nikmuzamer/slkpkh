...
<table width="643" height="123">
  ...
  <tr>
    <td><em>*Kemaskini Jenis Ahli</em></td>
	              </tr>
  <tr>
    <td><a href="jenisahli-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Jenis Ahli</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Jenis Ahli</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Jenis Ahli</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsJenisAhli['MembershipType']; ?></td>
                          <td class="center"><a href="bakat-add.php"></a> 
                            
                            <a href="jenisahli-edit.php?ID=<?php echo $row_rsJenisAhli['MembershipTypeID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a> 
                            
                            <a href="jenisahli-delete.php?ID=<?php echo $row_rsJenisAhli['MembershipTypeID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsJenisAhli = mysql_fetch_assoc($rsJenisAhli)); ?>
</table></td>
	              </tr>
	            </table>
