...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmBakat")) {
  $insertSQL = sprintf("INSERT INTO t109kod_bakat (f109kdbakat, f109desc) VALUES (%s, %s)",
    ...
    <td align="center"><table width="200" border="0">
      <tr>
        ...
        <td width="74%"><label for="txtbakat"></label>
	                    <label for="txtBahasa"><span id="txtsprybakat">
	                      <input type="text" name="txtbakat" id="txtbakat" />
      ...
      <tr>
        ...
        <td><label for="txtkdbakat"><span id="txtsprykdbakat">
                        <input type="text" name="txtkdbakat" id="txtkdbakat" />
...
<input type="hidden" name="MM_insert" value="frmBakat" />
              </form>
	        </div>
	      </div>
</div>
