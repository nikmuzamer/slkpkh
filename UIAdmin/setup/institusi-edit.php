...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmInstitusi")) {
  $insertSQL = sprintf("INSERT INTO t109kod_institusi (f109kdinst, f109desc) VALUES (%s, %s)",
                       GetSQLValueString($_POST['txtkdinstitusi'], "text"),
                       GetSQLValueString($_POST['txtinstitusi'], "text"));

  mysql_select_db($database_sqlconn, $sqlconn);
  $Result1 = mysql_query($insertSQL, $sqlconn) or die(mysql_error());

  $insertGoTo = "institusi.php";
  if (isset($_SERVER['QUERY_STRING'])) {
	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form action="<?php echo $editFormAction; ?>" name="frmInstitusi" id="frmInstitusi" method="POST">
<table width="643" height="70">
  <tr>
    <td><strong>INFO:</strong></td>
	              </tr>
  <tr>
    <td><em>*Tambah Institusi</em></td>
	              </tr>
  <tr>
    <td>&nbsp;</td>
	              </tr>
  <tr>
    <td align="center"><table width="635" border="0">
      <tr>
        <td width="26%"><div align="right"><strong>Nama Institusi: </strong></div></td>
        <td width="74%"><label for="txtinstitusi"></label>
	                    <label for="txtBahasa"><span id="txtspryinstitusi">
	                      <input type="text" name="txtinstitusi" id="txtinstitusi" />
                        <span class="textfieldRequiredMsg">*Wajib diisi.</span></span></label></td>
	                  </tr>
      <tr>
        <td><div align="right"><strong>Kod Institusi:</strong></div></td>
        <td><label for="txtkdinstitusi"><span id="txtsprykdinstitusi">
                        <input type="text" name="txtkdinstitusi" id="txtkdinstitusi" />
...
<input type="hidden" name="MM_insert" value="frmInstitusi" />
              </form>
	        </div>
	      </div>
</div>
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("txtspryinstitusi");
var sprytextfield2 = new Spry.Widget.ValidationTextField("txtsprykdinstitusi", "integer");
</script>
</body>
</html>
<?php
