	...
	<div id="page-bgtop">
		<div id="content">
		  <div class="post">
		    ...
		    <div class="entry">
		      <form id="form1" method="post" action="bahasa.php">
<table width="643" height="123">
  ...
  <tr>
    <td><a href="bahasa-add.php"><img src="../../images/database-add-icon.png" alt="Tambah Bahasa" width="16" height="16" />-Tambah Bahasa</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Bahasa</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Bahasa</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
      <?php do { ?>  
        <tr>
          <td><?php echo $row_rsbahasa['Lang']; ?></td>
          <td class="center">
                          
                          <a href="bahasa-add.php"></a>
                          
                          <a href="bahasa-edit.php?ID=<?php echo $row_rsbahasa['LangID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a> 
                          
                          <a href="bahasa-delete.php?ID=<?php echo $row_rsbahasa['LangID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
	                    </tr>
        <?php } while ($row_rsbahasa = mysql_fetch_assoc($rsbahasa)); ?>
                    </table></td>
	              </tr>
	            </table>
<script type="text/javascript">
