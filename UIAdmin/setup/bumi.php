...
mysql_select_db($database_sqlconn, $sqlconn);
$query_rsBumi = "SELECT * FROM t109kod_bumi";
...
<table width="643" height="123">
  ...
  <tr>
    <td><a href="bumi-add.php"><img src="../../images/database-add-icon.png" alt="" width="16" height="16" />-Tambah Status Bumiputra</a></td>
	              </tr>
  <tr>
    <td align="center"><table width="650" border="0">
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Maklumat Status Bmiputra</strong></td>
	                  </tr>
      <tr>
        <td width="518" bgcolor="#E7E4E6"><strong>Status Bumiputra</strong></td>
        <td width="122" bgcolor="#E7E4E6"><strong>Tindakan</strong></td>
	                  </tr>
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_rsBumi['f109bumiDesc']; ?></td>
                          <td class="center"><a href="bakat-add.php"></a> 
                            
                            <a href="bumi-edit.php?ID=<?php echo $row_rsBumi['f109bumiID']; ?>"><img src="../../images/database-process-icon.png" alt="" width="16" height="16" /></a> 
                            
                            <a href="bumi-delete.php?ID=<?php echo $row_rsBumi['f109bumiID']; ?>" onClick="return confirm_delete()"><img src="../../images/database-remove-icon.png" alt="" width="16" height="16" /></a></td>
                        </tr>
                        <?php } while ($row_rsBumi = mysql_fetch_assoc($rsBumi)); ?>
</table></td>
	              </tr>
	            </table>
