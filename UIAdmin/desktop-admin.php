...
$MM_restrictGoTo = "../UIUser/desktop-user.php";
...
<h1>&nbsp;</h1>
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Muka Utama Laman E-Recruitment</a></h2>
				<p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Thursday, 4 October, 2012 10:49 AM<!-- #EndDate -->
				</p>
				<div class="entry">
				  <table width="643" border="0" cellpadding="0" cellspacing="0">
				    <tr>
				      <td><table width="640" height="53">
		<tr>
		  <td><fieldset>
		    <legend>Laman Utama Sistem E-Recruitment</legend>
		    1. <a href="#Syarat_pertama">Objektif</a><br />
		    2. <a href="#Syarat_kedua">Deskripsi</a><br />
		    </fieldset></td>
	    </tr>
		</table>
		<p><strong>1)&nbsp; Objektif<a name="Syarat_pertama" id="Syarat_pertama"></a></strong></p>
		<ul type="disc">
		  <li>Calon-calon lantikan terus hendaklah berumur tidak         kurang dari 18 tahun pada tarikh tutup iklan. </li>
		  <li>Had umur calon yang sedang berkhidmat dengan         Kerajaan, Badan Berkanun dan Pihak Berkuasa Tempatan <br />
		    adalah tidak         melebihi 50 tahun. Manakala had umur calon yang memohon bagi kenaikan         pangkat <br />
		    secara lantikan (KPSL), adalah tidak melebihi 54 tahun pada         tarikh lantikan.<a href="#Menu_syarat"><img src="file:///C|/xampp/htdocs/images/arrow-up-icon.png" alt="" width="24" height="24" /></a></li>
	    </ul>
		<p><strong>2)&nbsp;&nbsp;Deskripsi<a name="Syarat_kedua" id="Syarat_kedua"></a>&nbsp; </strong></p>
		<ul type="disc">
		  <li>Mereka yang dilantik adalah tertakluk kepada         syarat-syarat skim perkhidmatan berkenaan yang sedang <br />
		    berkuatkuasa serta         pindaannya dibuat ke atasnya dari masa ke semasa. <em><a href="#Menu_syarat"><img src="file:///C|/xampp/htdocs/images/arrow-up-icon.png" alt="" width="24" height="24" /></a></em></li>
	    </ul></td>
	</tr>
			      </table>
				</div>
