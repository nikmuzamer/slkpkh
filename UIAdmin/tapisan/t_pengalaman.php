...
$query_rsUser = sprintf("SELECT * FROM t142_akaun WHERE f142noIC = %s ORDER BY f142username ASC", GetSQLValueString($colname_rsUser, "text"));
...
<div id="header">
  ...
  <!-- end #search -->
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Laman Tapisan Perjawatan Sistem E-Recruitment</a></h2>
		...
		<tr>
		  <td><fieldset>
		    <legend>Tapisan bagi Pengalaman Kerja</legend>
		...
		<ul type="disc">
		  <li>Proses tapisan bagi calon yang lulus kelayakan </li>
		  <li>Had umur calon yang sedang berkhidmat dengan         Kerajaan, Badan Berkanun dan Pihak Berkuasa Tempatan <br />
		    ...
		    secara lantikan (KPSL), adalah tidak melebihi 54 tahun pada         tarikh lantikan.<a href="#Menu_syarat"><img src="../../images/arrow-up-icon.png" alt="" width="24" height="24" /></a></li>
	    </ul>
		...
		<ul type="disc">
		  <li>Mereka yang dilantik adalah tertakluk kepada         syarat-syarat skim perkhidmatan berkenaan yang sedang <br />
		    berkuatkuasa serta         pindaannya dibuat ke atasnya dari masa ke semasa. <em><a href="#Menu_syarat"><img src="../../images/arrow-up-icon.png" alt="" width="24" height="24" /></a></em></li>
	    </ul>
		<p><em><a href="#Menu_syarat">ke atas</a></em></p></td>
	</tr>
			      </table>
				</div>
			</div>
