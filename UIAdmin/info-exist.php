...
<div id="wrapper">
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Iklan jawatan kosong di UPNM</a></h2>
				<p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Wednesday, 3 October, 2012 7:29 PM<!-- #EndDate -->
				</p>
				<div class="entry">
				  <p>Maklumat yang dimasukkan telah wujud dalam pangkalan data sistem E-Recruitment<strong></strong></p>
</div>
			</div>
	  </div>
		<!-- end #content -->
