...
<div id="wrapper">
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
			  <h2 class="title"><a href="#">Informasi</a></h2>
				<p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Wednesday, 11 March, 2015 9:24 AM<!-- #EndDate -->
                  <br />
				...
				<div class="entry">
                  ...
                  <ol class="style1">
                    <br>
                    <a href="cara-pohon.php"><img src="images/penting.gif" alt="" width="45" height="14" /></a> Pendaftaran akaun anda telah berjaya.<br /><br />
					Klik<a href="login.php"><strong> disini 
					</strong> </a>
					untuk login. Terima Kasih.<br />
                  </ol>
				</div>
			</div>
		</div>
