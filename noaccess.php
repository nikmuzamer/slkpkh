...
<div id="wrapper">
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#"> Amaran</a></h2>
				<p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Tuesday, 10 March, 2015 10:15 AM<!-- #EndDate -->
                  <br />
                </p>
				<div class="entry">
				  <p>Maaf. Anda tidak mempunyai akses untuk ke halaman utama Sistem Laporan Kesalahan Pegawai Kadet dan Hukuman.</p>
				  <p>Sila masukkan No Staf / No Tentera dan Password yang betul.</p>
				  <p>Sila klik <a href="login.php"><span class="style1">di sini</span>
					</a>untuk login semula.</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
