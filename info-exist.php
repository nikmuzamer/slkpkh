			...
			<div class="post">
			  <h2 class="title"><a href="#">Informasi</a></h2>
				<p class="meta">Kemaskini terakhir pada  
				  <!-- #BeginDate format:fcSw1a -->Wednesday, 11 March, 2015 2:38 PM<!-- #EndDate -->
                  <br />
				...
				<div class="entry">
                  ...
                  <ol class="style1">
					...
					<strong>Maaf, No Staf / No Tentera ini telah digunakan. </strong><br>
				    Pendaftaran Tidak Berjaya.<br /><br />
					Klik<a href="register.php"><strong> disini 
					</strong> </a>
					untuk daftar semula. Terima Kasih.<br />
                  </ol>
				</div>
			</div>
		</div>
