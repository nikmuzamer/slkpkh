	...
	<div id="header">
	  ...
	  <div id="search">
	    <div id="search2"> <span class="welcome"><br />
         <a href="tbm.php"><img src="../../images/icon-16-contacts.png" alt="" width="16" height="16" /></a> <?php echo $row_rsUser['f142Name']; ?></span></div>
      </div>
	  <br />
	  <!-- end #search -->
  </div>
...
<div id="content">
  ...
  <tr>
		      <td><table width="640" height="134">
<tr>
  <td height="128"><fieldset>
    <legend><strong>REKOD SURAT</strong></legend>
    <legend></legend>
    <legend></legend>
    <legend><strong>DETAIL SURAT MASUK &amp; KELUAR</strong><br />
        - <img src="../../images/penting.gif" alt="" width="45" height="14" />&nbsp;Surat yang keluar &amp; masuk boleh disemak &amp; akan dipaparkan dibawah.<br /><br />
        - <img src="../../images/penting.gif" alt="" width="45" height="14" />&nbsp;Sekiranya terdapat surat yang berkaitan, pengguna bolehlah terus berhubung dengan Bahagian Pos PTMK di aras bawah.</legend>
    <legend></legend>
    <legend></legend>
    <legend></legend>
    <legend></legend>
  ...
  <p><!-- #BeginDate format:fAm1a -->Monday May 19, 2014 9:28 PM<!-- #EndDate --></p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
</div>
		<!-- end #content -->
				<div id="sidebar"> 
        <ul>
		    	<li><?php include("tbm_menu.php"); ?></li>
		  </ul>
         </div>
